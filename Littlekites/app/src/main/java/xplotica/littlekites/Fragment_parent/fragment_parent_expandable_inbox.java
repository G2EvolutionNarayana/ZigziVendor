...
import xplotica.littlekites.Adapter_parent.parent_Exapandable_inbox_Adapter;
...
public class fragment_parent_expandable_inbox extends Fragment {

    parent_Exapandable_inbox_Adapter mListAdapter;
    ExpandableListView expListView;
    ArrayList<ReadHeader> listDataHeader;
    HashMap<String, ReadDetails_Parent_Inbox> listDataChild;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_parent_expandable_inbox, container, false);
        ...
        mListAdapter = new parent_Exapandable_inbox_Adapter(getActivity(), listDataHeader, listDataChild);
    ...
    private void prepareListData() {
        ...
        listDataHeader = new ArrayList<ReadHeader>();
        listDataChild = new HashMap<String, ReadDetails_Parent_Inbox>();
        Date dt = null;
        try {
                ...
                try {
                    ...
                    if (posts == null) {
                        ...
                        for (int i = 0; i < posts.length(); i++) {
                            ...
                            ReadHeader item = new ReadHeader();
                          ...
                          //  item.setTime(time);
                            ...
                            ReadDetails_Parent_Inbox feedDetail = new ReadDetails_Parent_Inbox(Title, desc);

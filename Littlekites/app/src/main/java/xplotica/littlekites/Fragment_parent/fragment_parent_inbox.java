...
import xplotica.littlekites.Adapter_parent.parent_inbox_Adapter;
 ...
 */
public class fragment_parent_inbox extends Fragment {


    JSONParser jsonParser = new JSONParser();
    ArrayList<HashMap<String, String>> arraylist1;
    private ArrayList<parent_inbox_feederInfo> allItems1 = new ArrayList<parent_inbox_feederInfo>();

    private RecyclerView mFeedRecyler;
    private ArrayList<parent_inbox_feederInfo> mListFeederInfo;
    private parent_inbox_feederInfo adapter;
    parent_inbox_Adapter mAdapterFeeds;
    RecyclerView rView;
    ...
    String[]Topic = new String[]{"Mathematics","Science","History","Science"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_parent_inbox, container, false);
...
/*
    ...
    private void setUpRecycler(){
        ...
        mListFeederInfo =new ArrayList<parent_inbox_feederInfo>();
        for(int i=0;i<Message.length;i++){
            parent_inbox_feederInfo notification_feederInfo = new parent_inbox_feederInfo();
            notification_feederInfo.setMessage(Message[i]);
            notification_feederInfo.setTime(Topic[i]);
            notification_feederInfo.setDate(Date[i]);


            mListFeederInfo.add(notification_feederInfo);
        }
        mAdapterFeeds= new parent_inbox_Adapter(getActivity(),mListFeederInfo);
        ...
        public String doInBackground(String... args) {
            ...
            try {
                ...
                for (int i = 0; i < responcearray.length(); i++) {
                    ...
                    parent_inbox_feederInfo item = new parent_inbox_feederInfo();

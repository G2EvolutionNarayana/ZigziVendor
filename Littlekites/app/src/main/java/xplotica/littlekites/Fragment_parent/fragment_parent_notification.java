...
import xplotica.littlekites.Adapter_parent.parent_Notification_Adapter;
import xplotica.littlekites.FeederInfo_parent.parent_Notification_feederInfo;
import xplotica.littlekites.R;

/**
 * Created by Sujata on 20-03-2017.
 */
public class fragment_parent_notification extends Fragment {

    ArrayList<HashMap<String, String>> arraylist1;
    private ArrayList<parent_Notification_feederInfo> allItems1 = new ArrayList<parent_Notification_feederInfo>();

    private RecyclerView mFeedRecyler;
    private ArrayList<parent_Notification_feederInfo> mListFeederInfo;
    private parent_Notification_feederInfo adapter;
    parent_Notification_Adapter mAdapterFeeds;
    RecyclerView rView;
    Context context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_parent_notification, container, false);
    ...
    private void setUpRecycler(){
        ...
        mListFeederInfo =new ArrayList<parent_Notification_feederInfo>();
        for(int i=0;i<Name.length;i++){
            parent_Notification_feederInfo notification_feederInfo = new parent_Notification_feederInfo();
        ...
        mAdapterFeeds= new parent_Notification_Adapter(getActivity(),mListFeederInfo);

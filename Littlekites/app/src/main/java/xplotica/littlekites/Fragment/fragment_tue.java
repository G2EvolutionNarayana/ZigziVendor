...
import xplotica.littlekites.Adapter.Tue_Adapter;
...
public class fragment_tue extends Fragment {
    ...
    private ArrayList<Tue_Info> mListFeederInfo;
    private Tue_Adapter mAdapterFeeds;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_tue, container, false);
    ...
    private void setUpRecycler() {
        ...
        mListFeederInfo = new ArrayList<Tue_Info>();
        for (int i = 0; i < Period.length; i++) {
            Tue_Info feedInfo = new Tue_Info();
        ...
        mAdapterFeeds = new Tue_Adapter(getActivity(), mListFeederInfo);
    ...
    class LoadSpinnerdata extends AsyncTask<String, String, String> {
        ...
        public String doInBackground(String... args) {
            ...
            userpramas.add(new BasicNameValuePair(End_Urls.TimeTable_DAYID, "2"));

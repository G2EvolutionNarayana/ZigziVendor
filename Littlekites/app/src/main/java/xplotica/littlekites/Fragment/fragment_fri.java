...
import xplotica.littlekites.Adapter.Fri_Adapter;
...
public class fragment_fri extends Fragment {
    ...
    private ArrayList<Fri_Info> mListFeederInfo;
    private Fri_Adapter mAdapterFeeds;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_fri, container, false);
    ...
    private void setUpRecycler() {
        ...
        mListFeederInfo = new ArrayList<Fri_Info>();
        for (int i = 0; i < Period.length; i++) {
            Fri_Info feedInfo = new Fri_Info();
        ...
        mAdapterFeeds = new Fri_Adapter(getActivity(), mListFeederInfo);
    ...
    class LoadSpinnerdata extends AsyncTask<String, String, String> {
        ...
        public String doInBackground(String... args) {
            ...
            userpramas.add(new BasicNameValuePair(End_Urls.TimeTable_DAYID, "5"));

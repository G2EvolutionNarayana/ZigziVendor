...
import xplotica.littlekites.Adapter.Fragment_inbox_Adapter;
...
public class fragment_inbox  extends Fragment {
    ...
    private ArrayList<Fragment_inbox_feederInfo> allItems1 = new ArrayList<Fragment_inbox_feederInfo>();

    private RecyclerView mFeedRecyler;
    private ArrayList<Fragment_inbox_feederInfo> mListFeederInfo;
    private Fragment_inbox_feederInfo adapter;
    Fragment_inbox_Adapter mAdapterFeeds;
    RecyclerView rView;
    Context context;
    ...
    String[]Message = new String[]{"Today my son is not feeling well.","Today my son is not feeling well.","Today my son is not feeling well.","Today my son is not feeling well.","Today my son is not feeling well."};
    ...
    private void setUpRecycler(){
        ...
        mListFeederInfo =new ArrayList<Fragment_inbox_feederInfo>();
        for(int i=0;i<Topic.length;i++){
            Fragment_inbox_feederInfo feederInfo = new Fragment_inbox_feederInfo();
        ...
        mAdapterFeeds= new Fragment_inbox_Adapter(getActivity(),mListFeederInfo);
            ...
            //implements RemoveClickListner
    {
        ...
        public String doInBackground(String... args) {
            ...
            try {
                ...
                for (int i = 0; i < responcearray.length(); i++) {
                    ...
                    Fragment_inbox_feederInfo item = new Fragment_inbox_feederInfo();


                    item.set_name(post.optString("product_name"));
                    item.set_section(post.optString("product_company"));
                    item.set_rollno(post.optString("product_price"));
                    item.set_topic(post.optString("product_rating"));
        ...
        protected void onPostExecute(String responce) {
            ...
            if (status.equals("yes")){
                ...
                mAdapterFeeds = new Fragment_inbox_Adapter(getActivity(), allItems1);

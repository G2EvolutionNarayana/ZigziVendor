...
import xplotica.littlekites.Adapter.Sat_Adapter;
...
public class fragment_sat extends Fragment {
    ...
    private ArrayList<Sat_Info> mListFeederInfo;
    private Sat_Adapter mAdapterFeeds;
    ...
    String[] Class = new String[]{ "3", "5", "8","1", "2", "4", "7", "6"};

    String[] Section = new String[]{ "B", "C", "B","A", "C", "B", "A", "A"};

    String[] Subject = new String[]{ "Social", "Maths", "Maths", "Maths", "Maths","Maths", "Maths", "Social"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_sat, container, false);
    ...
    private void setUpRecycler() {
        ...
        mListFeederInfo = new ArrayList<Sat_Info>();
        for (int i = 0; i < Period.length; i++) {
            Sat_Info feedInfo = new Sat_Info();
        ...
        mAdapterFeeds = new Sat_Adapter(getActivity(), mListFeederInfo);
    ...
    class LoadSpinnerdata extends AsyncTask<String, String, String> {
        ...
        public String doInBackground(String... args) {
            ...
            userpramas.add(new BasicNameValuePair(End_Urls.TimeTable_DAYID, "6"));

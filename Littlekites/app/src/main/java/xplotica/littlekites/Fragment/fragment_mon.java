...
import xplotica.littlekites.Adapter.Mon_Adapter;
...
public class fragment_mon extends Fragment {
    ...
    private ArrayList<Mon_Info> mListFeederInfo;
    private Mon_Adapter mAdapterFeeds;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_mon, container, false);
    ...
    private void setUpRecycler() {
        ...
        mListFeederInfo = new ArrayList<Mon_Info>();
        for (int i = 0; i < Period.length; i++) {
            Mon_Info feedInfo = new Mon_Info();
        ...
        mAdapterFeeds = new Mon_Adapter(getActivity(), mListFeederInfo);
    ...
    class LoadSpinnerdata extends AsyncTask<String, String, String> {
        ...
        public String doInBackground(String... args) {
            ...
            userpramas.add(new BasicNameValuePair(End_Urls.TimeTable_DAYID, "1"));

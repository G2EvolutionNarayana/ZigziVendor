...
import xplotica.littlekites.Adapter.Thu_Adapter;
...
public class fragment_thu extends Fragment {
    ...
    private ArrayList<Thu_Info> mListFeederInfo;
    private Thu_Adapter mAdapterFeeds;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_thu, container, false);
    ...
    private void setUpRecycler() {
        ...
        mListFeederInfo = new ArrayList<Thu_Info>();
        for (int i = 0; i < Period.length; i++) {
            Thu_Info feedInfo = new Thu_Info();
        ...
        mAdapterFeeds = new Thu_Adapter(getActivity(), mListFeederInfo);
    ...
    class LoadSpinnerdata extends AsyncTask<String, String, String> {
        ...
        public String doInBackground(String... args) {
            ...
            userpramas.add(new BasicNameValuePair(End_Urls.TimeTable_DAYID, "4"));

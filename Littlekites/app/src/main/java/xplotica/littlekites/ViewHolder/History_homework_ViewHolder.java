 ...
 */
public class History_homework_ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

public TextView topic;
public TextView topic_details;


public History_homework_ViewHolder(View itemView) {

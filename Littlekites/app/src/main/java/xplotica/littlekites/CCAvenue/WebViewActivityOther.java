...
public class WebViewActivityOther extends AppCompatActivity {
    ...
    String instalmentid, stramount, strdesc;
    ...
    public void onCreate(Bundle bundle) {
        ...
        SharedPreferences prefuserdata4= getSharedPreferences("paymentdesc",0);
        strdesc=prefuserdata4.getString("strdesc","");
...
//get rsa key method
            ...
            class MyJavaScriptInterface {
                ...
                public void processHTML(String html) {
                    ...
                    if (strtransactionstatus.equals("Success")){
                        ...
                        Toast.makeText(WebViewActivityOther.this, strtransactionstatus, Toast.LENGTH_SHORT).show();
                    }
    ...
    public void show_alert(String msg) {
        AlertDialog alertDialog = new AlertDialog.Builder(
                WebViewActivityOther.this).create();
            ...
            //implements RemoveClickListner
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(WebViewActivityOther.this);
        ...
        public String doInBackground(String... args) {
            ...
            userpramas.add(new BasicNameValuePair(End_Urls.PARENTPAYMENT_installmentId, strdesc));
            ...
            userpramas.add(new BasicNameValuePair(End_Urls.PARENTPAYMENT_paymentType, "Others"));
        ...
        protected void onPostExecute(String responce) {
            ...
            if (status.equals("success")){
                ...
                Toast.makeText(WebViewActivityOther.this, ""+arrayresponce, Toast.LENGTH_SHORT).show();

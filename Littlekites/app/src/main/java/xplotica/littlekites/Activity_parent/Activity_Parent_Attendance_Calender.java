...
public class Activity_Parent_Attendance_Calender extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__parent__attendance__calender);
            ...
            //implements RemoveClickListner
    {
      ...
      //  private ProgressDialog pDialog;
        ...
        public String doInBackground(String... args) {
            ...
            userpramas.add(new BasicNameValuePair(End_Urls.PATTEN_DETAILS_SCHOOLNAME, School_id));
            userpramas.add(new BasicNameValuePair(End_Urls.PATTEN_DETAILS_CLASSNAME, Classid));
            userpramas.add(new BasicNameValuePair(End_Urls.PATTEN_DETAILS_SECTIONNAME, Sectionid));
            userpramas.add(new BasicNameValuePair(End_Urls.PATTEN_DETAILS_LOGINTYPE, type));
            userpramas.add(new BasicNameValuePair(End_Urls.PATTEN_DETAILS_LOGINID, Student_id));
            userpramas.add(new BasicNameValuePair(End_Urls.PATTEN_DETAILS_ABSENTDATE, strfinaldate));

            JSONObject json = jsonParser.makeHttpRequest(End_Urls.PATTEN_DETAILS, "POST", userpramas);
        ...
        protected void onPostExecute(String responce) {
            ...
            if (responcearray == null || responcearray.length() == 0){
                ...
                for (int i = 0; i < responcearray.length(); i++) {
                    ...
                    try {
                        ...
                        // String dtStart = post.optString("studentAbsentDate");
                        String strabsent = post.optString("absentOn");
                        ...
                        if (strabsent.equals("WholeDay")) {
                            ...
                            if (caldroidFragment != null) {
                                ...
                                Drawable drawable = ResourcesCompat.getDrawable(getResources(), R.drawable.calendarcircle, null);
                                ColorDrawable blue = new ColorDrawable(getResources().getColor(android.R.color.holo_red_dark));
                                // ColorDrawable blue = new ColorDrawable(getResources(R.drawable.calendar_next_arrow));
                        ...
                        }else if (strabsent.equals("HalfDay")){
                            String dtStart =post.optString("studentAbsentDate");;
                            greenstrDate = null;
                            try {
                                greenstrDate = format.parse(dtStart);

 ...
 */
public class parent_RecyclerViewHolder_home extends RecyclerView.ViewHolder implements View.OnClickListener{
    ...
    public parent_RecyclerViewHolder_home(View itemView) {

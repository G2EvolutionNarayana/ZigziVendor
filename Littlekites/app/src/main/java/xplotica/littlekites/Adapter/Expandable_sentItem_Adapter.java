...
public class Expandable_sentItem_Adapter extends BaseExpandableListAdapter {

    private Context mContext;


    // Context context;
    private ArrayList<ReadHeader_SentItem> _listDataHeader; // header titles
    // child data in format of header title, child title
    private HashMap<String, ReadDetails_SentItem> _listDataChild;

    private Exapandable_inbox_Adapter.customButtonListener customListner;

    public Expandable_sentItem_Adapter(Context context, ArrayList<ReadHeader_SentItem> listDataHeader,
                                       HashMap<String, ReadDetails_SentItem> listChildData) {
        this.mContext = context;
        this._listDataHeader = listDataHeader;
        this._listDataChild = listChildData;
    }

    public void setData(ArrayList<ReadHeader_SentItem> listDataHeader,
                        HashMap<String, ReadDetails_SentItem> listChildData) {
        this._listDataHeader = listDataHeader;
        this._listDataChild = listChildData;
    ...
    public void setCustomButtonListner(Exapandable_inbox_Adapter.customButtonListener listener) {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ReadHeader_SentItem feedHeader = (ReadHeader_SentItem) getGroup(groupPosition);
        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) this.mContext
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = infalInflater.inflate(R.layout.dashboardrow_sentitem, null);
        }
...
*/
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        final ReadDetails_SentItem childDetail = (ReadDetails_SentItem) getChild(groupPosition, childPosition);

        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) this.mContext
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = infalInflater.inflate(R.layout.dashboardrow_sentitem_child, null);
        }

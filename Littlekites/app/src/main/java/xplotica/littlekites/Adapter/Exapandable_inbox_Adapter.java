...
public class Exapandable_inbox_Adapter extends BaseExpandableListAdapter {
    ...
    // Context context;
    private ArrayList<ReadHeader_inbox> _listDataHeader; // header titles
    // child data in format of header title, child title
    private HashMap<String,ReadDetails_inbox> _listDataChild;

    private customButtonListener customListner;

    public Exapandable_inbox_Adapter(Context context, ArrayList<ReadHeader_inbox> listDataHeader,
                                     HashMap<String, ReadDetails_inbox> listChildData) {
        this.mContext = context;
        this._listDataHeader = listDataHeader;
        this._listDataChild = listChildData;
    }

    public void setData(ArrayList<ReadHeader_inbox> listDataHeader,
                        HashMap<String, ReadDetails_inbox> listChildData) {
        this._listDataHeader = listDataHeader;
        this._listDataChild = listChildData;
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ReadHeader_inbox feedHeader = (ReadHeader_inbox) getGroup(groupPosition);
        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) this.mContext
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = infalInflater.inflate(R.layout.dashboardrow_inbox, null);
        }
...
*/
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        final ReadDetails_inbox childDetail = (ReadDetails_inbox) getChild(groupPosition, childPosition);

        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) this.mContext
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = infalInflater.inflate(R.layout.dashboardrow_inbox_child, null);
        }

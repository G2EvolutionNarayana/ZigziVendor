...
import g2evolution.GMT.Activity.Product_List;
...
public class Fragment_filter_new_Pagination extends AppCompatActivity implements RecyclerViewDataAdapter.OnItemClick{
...
*/
        ...
        mFeedRecyler2.setLayoutManager(new LinearLayoutManager(Fragment_filter_new_Pagination.this));

//  -----pagination----------------//
        progressBar1 = (ProgressBar) findViewById(R.id.progressBar1);


        requestQueue = Volley.newRequestQueue(Fragment_filter_new_Pagination.this);
        ...
        mAdapterFeeds2 = new Adapter_Product_List(Fragment_filter_new_Pagination.this, allItems3);
...
/*
                 ...
                 //   Toast.makeText(Fragment_filter_new_Pagination.this, ""+message, Toast.LENGTH_LONG).show();

                }

            } else {

                Toast.makeText(Fragment_filter_new_Pagination.this, "Something went wrong", Toast.LENGTH_LONG).show();
                //dialog.dismiss();
    ...
    public JSONObject makingJson2() {
        ...
        try {
          ...
          //  jobj.put(EndUrl.Filter_categoryId,categoryname);

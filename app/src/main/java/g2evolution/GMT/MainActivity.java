...
import g2evolution.GMT.Activity.Activity_ContactUs;
...
import g2evolution.GMT.Activity.Activity_subcategory_details;
import g2evolution.GMT.Activity.Login;
import g2evolution.GMT.Activity.My_Bookings_Activity;
import g2evolution.GMT.Activity.My_Orders;
import g2evolution.GMT.Activity.Notifications_Activity;
import g2evolution.GMT.Adapter.Adapter_main;
import g2evolution.GMT.Adapter.MyListAdapter_MainActivity;
import g2evolution.GMT.Adapter.spinnerAdapter;
import g2evolution.GMT.FeederInfo.DetailInfo;
import g2evolution.GMT.FeederInfo.FeedDetail;
import g2evolution.GMT.FeederInfo.FeedHeader;
import g2evolution.GMT.FeederInfo.FeederInfo_main;
import g2evolution.GMT.FeederInfo.HeaderInfo;
...
import g2evolution.GMT.Fragment.Fragment_Home_New;
import g2evolution.GMT.Fragment.Fragment_filter_new_Pagination;
...
import g2evolution.GMT.Utility.JSONfunctions;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, Adapter_main.OnItemClick{
    ...
    String searchType;
    TextView texthome,textoffers,account,aboutus,termsconditon,contactus;
    ...
    String  headers;
    TextView profilename,profileid,logout;
...
//----------------------------------------------------------------------------------------------------------
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuItemcart = menu.findItem(R.id.tracking);
/*

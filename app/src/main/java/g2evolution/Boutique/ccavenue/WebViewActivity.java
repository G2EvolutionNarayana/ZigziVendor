...
import static g2evolution.Boutique.EndUrl.PlaceOrder_URL;
...
public class WebViewActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        strCity = prefuserdata4.getString("addressCity", "");
        strState = prefuserdata4.getString("addressState", "");
        strZipcode = prefuserdata4.getString("addressZipCode", "");
        strLandMark = prefuserdata4.getString("addressLandMark", "");
        SharedPreferences prefuserdata5 = getSharedPreferences("PriceDeatils", 0);
        grandtotal = prefuserdata5.getString("total_price", "");
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response != null && !response.equals("")) {
                            ...
                            Log.e("testing vresponce", vResponse);
...
//            jobj.put("transaction_id", strtransactionid);
            ...
            jobj2.put(EndUrl.PlaceOrder_user_id, _userId);
            jobj2.put(EndUrl.PlaceOrder_delivery_address_id, addressid);
            jobj2.put(EndUrl.PlaceOrder_payment_mode_id, "2");
            jobj2.put(EndUrl.payment_status, "success");
    ...
    private class RenderView extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            if (!ServiceUtility.chkNull(vResponse).equals("")
                ...
                vEncVal.append(ServiceUtility.addToPostParams(AvenuesParams.BILLING_NAME, _userName));
                vEncVal.append(ServiceUtility.addToPostParams(AvenuesParams.BILLING_ADDRESS, strLandMark));
                vEncVal.append(ServiceUtility.addToPostParams(AvenuesParams.BILLING_CITY, strCity));
                vEncVal.append(ServiceUtility.addToPostParams(AvenuesParams.BILLING_STATE, strState));
                vEncVal.append(ServiceUtility.addToPostParams(AvenuesParams.BILLING_ZIP, strZipcode));
                vEncVal.append(ServiceUtility.addToPostParams(AvenuesParams.BILLING_COUNTRY, "India"));
                vEncVal.append(ServiceUtility.addToPostParams(AvenuesParams.BILLING_TEL, _usermob));
                vEncVal.append(ServiceUtility.addToPostParams(AvenuesParams.BILLING_EMAIL, _userEmail));
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                Log.e("testing", "AvenuesParams.ACCESS_CODE  " + AvenuesParams.ACCESS_CODE);
                Log.e("testing", "AvenuesParams.ACCESS_CODE  " + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.ACCESS_CODE)));
                Log.e("testing", "AvenuesParams.ACCESS_CODE  " + AvenuesParams.MERCHANT_ID);
                Log.e("testing", "AvenuesParams.ACCESS_CODE  " + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.MERCHANT_ID)));
                Log.e("testing", "AvenuesParams.ACCESS_CODE  " + AvenuesParams.ORDER_ID);
                Log.e("testing", "AvenuesParams.ACCESS_CODE  " + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.ORDER_ID)));
                Log.e("testing", "AvenuesParams.ACCESS_CODE  " + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.ORDER_ID)));
                Log.e("testing", "AvenuesParams.ACCESS_CODE  " + AvenuesParams.REDIRECT_URL);
                Log.e("testing", "AvenuesParams.ACCESS_CODE  " + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.REDIRECT_URL)));
                Log.e("testing", "URLEncoder.encode(encVal, \"UTF-8\") " + URLEncoder.encode(encVal, "UTF-8"));
...
//            JSONObject json = jsonParser.makeHttpRequest(EndUrl.PlaceOrder_URL, "POST", userpramas);
            ...
            return postJsonObject(PlaceOrder_URL, makingJson());
        }
...
*/
                    ...
                    prefeditor.putString("order_id", "" + mainIntent.getStringExtra(AvenuesParams.ORDER_ID));
                    ...
                    order_success.setText(mainIntent.getStringExtra(AvenuesParams.ORDER_ID));
                    TextView textorderamount = (TextView) convertView.findViewById(R.id.textorderamount);
                    textorderamount.setText(mainIntent.getStringExtra(AvenuesParams.AMOUNT));

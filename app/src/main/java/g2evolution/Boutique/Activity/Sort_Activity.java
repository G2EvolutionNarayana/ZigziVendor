...
public class Sort_Activity extends AppCompatActivity implements RecyclerViewDataAdapter.OnItemClick{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences prefuserdata13 = getSharedPreferences("brnadFiltertype", 0);
        strlistbrnadid = prefuserdata13.getString("Filtertype", "");
...
*/
        ...
        mFeedRecyler2.setLayoutManager(new LinearLayoutManager(Sort_Activity.this));

//  -----pagination----------------//
        progressBar1 = (ProgressBar) findViewById(R.id.progressBar1);


        requestQueue = Volley.newRequestQueue(Sort_Activity.this);

        //Calling method to get data to fetch data
        new PRODUCT_LIST().execute();


        mAdapterFeeds2 = new Adapter_Product_List(Sort_Activity.this, allItems3);
...
/*
                ...
                Toast.makeText(Sort_Activity.this, "Something went wrong", Toast.LENGTH_LONG).show();
                //dialog.dismiss();
    ...
    public JSONObject makingJson2() {
        ...
        try {
            ...
            jobj.put(EndUrl.Filter_brandName,strlistbrnadid);

...
import g2evolution.Boutique.entit.Completed_Booking_List;

/**
 * Created by Jana on 2/22/2019.
 */

public class Completed_Booking_Adapter extends RecyclerView.Adapter<Completed_Booking_Adapter.Title_List_ViewHolder>{

    private List<Completed_Booking_List> completed_booking_lists;
    private Completed_Booking_Adapter.OnItemlevelsinside onItemlevels;
    ...
    public Completed_Booking_Adapter(Context mCtx, List<Completed_Booking_List> completed_booking_lists, Completed_Booking_Adapter.OnItemlevelsinside onItemlevels) {
        this.mCtx = mCtx;
        this.completed_booking_lists = completed_booking_lists;
    ...
    @NonNull
    @Override
    public Completed_Booking_Adapter.Title_List_ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.adpater_new_booking, parent, false);
        return new Completed_Booking_Adapter.Title_List_ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Completed_Booking_Adapter.Title_List_ViewHolder holder, final int position) {

        final Completed_Booking_List follow = completed_booking_lists.get(position);
    ...
    {
        return completed_booking_lists.size();
    }

...
public class Cancelled_Orders_Adapter extends RecyclerView.Adapter<Cancelled_Orders_Adapter.Title_List_ViewHolder>{

    private List<Cancelled_Orders_List> cancelled_orders_lists;
    private Cancelled_Orders_Adapter.OnItemlevelsinside onItemlevels;
    ...
    public Cancelled_Orders_Adapter(Context mCtx, List<Cancelled_Orders_List> cancelled_orders_lists, Cancelled_Orders_Adapter.OnItemlevelsinside onItemlevels) {
        this.mCtx = mCtx;
        this.cancelled_orders_lists = cancelled_orders_lists;
    ...
    @NonNull
    @Override
    public Cancelled_Orders_Adapter.Title_List_ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.adpater_new_booking, parent, false);
        return new Cancelled_Orders_Adapter.Title_List_ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Cancelled_Orders_Adapter.Title_List_ViewHolder holder, final int position) {

        final Cancelled_Orders_List follow = cancelled_orders_lists.get(position);
    ...
    {
        return cancelled_orders_lists.size();
    }
